  ...
  return (
    <div className="flex items-center justify-center gap-1 mt-4">
      <button
        ...
        disabled={page === 1}
        className="px-3 h-8 text-xs font-semibold border border-sage-mid text-navy bg-white hover:bg-sage disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
      >
        ← Prev
      </button>
