...
const SECTIONS = [
  ...
  { href: "/charity/zakat/pay", icon: Heart, label: "Pay Zakat", desc: "Pay zakat to verified foundations" },
  { href: "/charity/zakat/history", icon: Clock, label: "Zakat History", desc: "View your past zakat payments" },
