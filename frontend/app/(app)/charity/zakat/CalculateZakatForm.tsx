  ...
  return (
    <div className="bg-white border border-sage-mid p-5">
      ...
      {state && !state.error && state.zakat_due !== undefined && (
        <div className={`mt-5 p-4 ${state.is_eligible ? "bg-orange/10 border border-orange/20" : "bg-sage border border-sage-mid"}`}>
          ...
          {state.is_eligible && (
            <a href="/charity/zakat?tab=pay" className="inline-block mt-3 bg-teal text-white text-sm font-semibold px-4 py-2 hover:bg-teal/90">
              Pay Zakat Now
            </a>
          )}
        </div>
