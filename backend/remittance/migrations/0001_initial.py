    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exchange_rate', models.DecimalField(decimal_places=2, help_text='Spot exchange rate per Sarraf/Hawala principles', max_digits=8)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('partner', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='remittances', to='remittance.remittancepartner')),
            ...
            options={
                ...
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', '-created_at'], name='remittance__user_id_f4de5f_idx')],
            },
        ),
    ]
